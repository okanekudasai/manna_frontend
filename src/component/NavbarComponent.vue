        ...
        <div id="nav_bar">
            <div class="flex flex_vertical_center flex_horizontal_center" id="nav_bar_box">
                <router-link to="/mainPage">
                    <div class="nav_card">
                        <div v-if="store.uri == 'mainPage'"><img src="@/img/home_selected.svg" alt="" class="selected_icon"></div>
                        <div v-else><img src="@/img/home_not_selected.svg" alt="" class="not_selected_icon"></div>
                        <div>홈</div>
                    </div>
                </router-link>    
                <div class="nav_card">
                    <div v-if="store.uri == 'friendPage'"><img src="@/img/friend_selected.svg" alt="" class="selected_icon"></div>
                    <div v-else><img src="@/img/friend_not_selected.svg" alt="" class="not_selected_icon"></div>
                    <div>친구</div>
                </div>
                <div class="nav_card">
                    <div v-if="store.uri == 'chatPage'"><img src="@/img/chat_selected.svg" alt="" class="selected_icon"></div>
                    <div v-else><img src="@/img/chat_not_selected.svg" alt="" class="not_selected_icon"></div>
                    <div>지난대화</div>
                </div>
                <router-link to="/bulletinBoard">
                    <div class="nav_card">
                        <div v-if="store.uri == 'bulletinBoardPage'"><img src="@/img/bullet_selected.svg" alt="" class="selected_icon"></div>
